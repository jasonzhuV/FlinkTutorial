 ...
 *               连续三次登陆失败
 */
public class Demo057CEPLoginFail {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<LoginEvent> stream = env
            .fromElements(new LoginEvent("user-1", "fail", "0.0.0.1", 1000L),
                new LoginEvent("user-1", "fail", "0.0.0.2", 2000L), new LoginEvent("user-1", "fail", "0.0.0.3", 3000L),
        ...
        SingleOutputStreamOperator<String> result =
            patternStream.select(new PatternSelectFunction<LoginEvent, String>() {
                ...
                public String select(Map<String, List<LoginEvent>> map) throws Exception {
                    ...
                    return first.userId + " 在ip：" + first.ipAddr + " | " + second.ipAddr + " | " + third.ipAddr + " | "
                        + "登录失败！";
                }
            });
    ...
    public static class LoginEvent {
        ...
        public String toString() {
            return "LoginEvent{" + "userId='" + userId + '\'' + ", eventType='" + eventType + '\'' + ", ipAddr='"
                + ipAddr + '\'' + ", timestamp=" + new Timestamp(timestamp) + '}';
        }
    }
}
