...
// * <p>
// * description: 使用布隆过滤器，减小去重时的内存压力
// */
// public class Example02BloomFilter {
...
// .keyBy(e -> true).window(TumblingEventTimeWindows.of(Time.seconds(10)))
...
//
// @Override
// public Tuple2<BloomFilter<String>, Long> merge(Tuple2<BloomFilter<String>, Long> bloomFilterLongTuple2,
// Tuple2<BloomFilter<String>, Long> acc1) {
// return null;
// }
// }
//
...
//
// @Override
// public void process(Boolean aBoolean, Context context, Iterable<Long> elements, Collector<String> out)
// throws Exception {
