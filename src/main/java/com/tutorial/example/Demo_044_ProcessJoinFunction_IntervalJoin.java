 ...
 */
public class Demo_044_ProcessJoinFunction_IntervalJoin {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<String, String, Long>> clickStream = env
                .fromElements(
                        Tuple3.of("Mary", "click", 20 * 60 * 1000L)
                )
        ...
        SingleOutputStreamOperator<Tuple3<String, String, Long>> browseStream = env
                .fromElements(
                        Tuple3.of("Mary", "browse", 15 * 60 * 1000L),
                        Tuple3.of("Mary", "browse", 11 * 60 * 1000L),
                        Tuple3.of("Mary", "browse", 9 * 60 * 1000L),
                        Tuple3.of("Mary", "browse", 21 * 60 * 1000L)
                )
                .assignTimestampsAndWatermarks(
                        WatermarkStrategy.<Tuple3<String, String, Long>>forMonotonousTimestamps()
                                .withTimestampAssigner(new SerializableTimestampAssigner<Tuple3<String, String, Long>>() {
